function [ w_m,w_T_m ] = FillingGaps_Double_Filter_V4( w_m,w_T_m )
...
if starttime ~= 1
    ...
    for i = 1:endtime-rightvalue - 1
        ...
        if a(1,i) ~= rightvalue+i-1
            ...
            a(:,1:ending_ind+count+1) = [a(:,1:i-1),[rightvalue+i-1;NaN;],a(:,i:ending_ind+count)];
            count = count + 1;
        end
        if mod(i,2000) == 0
            i
